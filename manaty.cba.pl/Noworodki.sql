...
--
-- Host: 127.0.0.1
-- Czas generowania: 27 Kwi 2018, 10:37
...
CREATE TABLE `Noworodki` (
  `Identyfikator` int(255) NOT NULL,
  `plec` varchar(255) DEFAULT NULL,
  `imie` varchar(255) DEFAULT NULL,
  `data_urodzenia` varchar(255) DEFAULT NULL,
  `waga` int(255) DEFAULT NULL,
  `wzrost` int(255) DEFAULT NULL,
  `identyfikator_matki` int(255) DEFAULT NULL
...
INSERT INTO `Noworodki` (`Identyfikator`, `plec`, `imie`, `data_urodzenia`, `waga`, `wzrost`, `identyfikator_matki`) VALUES
